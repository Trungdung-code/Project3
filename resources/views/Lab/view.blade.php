                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                            <button type="button" rel="tooltip" class="btn btn-success">
                                                                <i class="material-icons"><a class="chuyendevice" href="{{ route('Device.edit', $list->idDevice) }}">edit</a></i>
                                                            </button>
                                                    </td>
                                                    <td class="td-actions text-right">
                                                            <button type="button" rel="tooltip" class="btn btn-success">
                                                                <i class="material-icons"><a class="chuyendevice" href="{{ route('SendStorage.edit',  $list->idDevice) }}">edit</a></i>
                                                            </button>
                                                    </td>
                                                </tr>
                                                @endforeach
