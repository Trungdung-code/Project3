...
<div class="container-fluid">
            <h1>&nbsp;&nbsp;&nbsp;Sửa thiết bị phòng kho</h1>
            <form action="{{ route('EditSDevice.update',$edit->idDevice)  }}" method="post">
                @method("PUT")
                @csrf
                                <div class="card-content">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left">Chuyển kho</label>
                                                <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                <div class="custom-select">
                                                    <div class="select-container">
                                                    <select name="lab" class="khungselect2" value="{{ $edit->status }}">
                                                            @foreach ($lab as $idlab)
                                                                <option value="{{  $idlab->idSLab }} ">
                                                                    {{ $idlab->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
