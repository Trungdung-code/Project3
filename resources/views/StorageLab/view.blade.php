        ...
        <div class="col-md-12">
                            <div class="card card-plain">
                                ...
                                <div class="card-content">
                                    <h3 class="card-title">PHÒNG KHO {{ $idlab }}</h3>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        <button type="button" rel="tooltip" class="btn btn-success">
                                                            <i class="material-icons"><a class="chuyendevice" href="{{ route('EditSDevice.edit', $list->idDevice) }}">edit</a></i>
                                                        </button>
                                                    </td>
                                                    <td class="td-actions text-right">
                                                        <button type="button" rel="tooltip" class="btn btn-success">
                                                            <i class="material-icons"><a class="chuyendevice" href="{{ route('BackLab.edit', $list->idDevice) }}">edit</a></i>
                                                        </button>
                                                    </td>
                                                    <td class="td-actions text-right">
                                                        <button type="button" rel="tooltip" class="btn btn-danger">
                                                            <i class="material-icons"><a class="chuyendevice" href="{{ route('HideDevice.edit', $list->idDevice) }}">close</a></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                                @endforeach
